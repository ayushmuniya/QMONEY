...
// import com.crio.warmup.stock.exception.JsonProcessingException;
...
public class AnnualReturnsController {
  ...
  @PostMapping("/analyze")
  @ResponseBody
  public PortfolioResponse calculateReturns(@RequestBody Portfolio portfolio) throws InterruptedException {
    ...
    try {
      return PortfolioResponse.builder().annualizedReturns(portfolioManager.calculateAnnualizedReturn(portfolio.getPortfolioTrades(), endDate)).calculationsDate(endDate).name(portfolio.getName()).build();
